...
export function createNightingaleChart(elementId, title, labels, data) {
    ...
    var option = {
        ...
        //     return `${params.seriesName}<br/>${params.name}: ${secondsToString(params.value)}`;
        //   }
        // },
        legend: {
            orient: 'vertical',
...
export function updateStats(today, labels, data) {
    ...
    chrome.storage.local.get(yesterdayDate, (result) => {
        const yesterdayData = result[yesterdayDate] || {};
